...
@router.get("/global_setting/{config_key}")
async def get_global_setting(req: Request, config_key:str):
    setting = process_setting.get_setting_config(config_key)
    result = server_schema.CommonResponse
    return result.success(setting)

@router.post("/global_setting/{config_key}")
async def set_global_setting(req: Request, config_key:str, config_param:str):
    setting = process_setting.set_setting_config(config_key, config_param)
    result = server_schema.CommonResponse
    return result.success(setting)